    ...
    <section className="w-screen h-screen min-h-[400px] flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center justify-center gap-4">
        <div className="flex flex-col items-center">
          <span className="text-5xl md:text-7xl font-black tracking-tight drop-shadow-2xl text-center select-none leading-none uppercase" style={{letterSpacing: '0.05em'}}>
            <span
              className="bg-gradient-to-b from-gray-200 via-gray-400 to-gray-800 bg-clip-text text-transparent drop-shadow-[0_2px_14px_rgba(0,0,0,0.95)]"
          ...
          <span className="text-white/80 text-lg md:text-2xl font-light tracking-widest text-center select-none mt-2 md:mt-4 uppercase" style={{letterSpacing: '0.3em', fontFamily: 'serif'}}>
            Collection
          </span>
        </div>
        {/* Botão arrow down */}
        ...
        >
        <div
          className="group flex items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-full border-2 border-white/30 bg-white/5 hover:scale-110 transition-all duration-300 cursor-pointer shadow-lg"
        >
          <svg
